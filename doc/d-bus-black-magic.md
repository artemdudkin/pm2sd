1. There are two use cases for non-privilged users at Linux: (1) configure service as privileged user and run service as non-privilged user and (2) configure and run service as non-privileged user. This instructions is all about second option (as first option available by default)
